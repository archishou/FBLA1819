...
public class FinancialMathTest {
    ...
    public FinancialMathTest() {
        ...
        questions.add(new QuestionModel("Mary Jones worked 44 hours last week earning an hourly rate of $17.25. " +
                "What is Mary’s gross pay for the week? They work a 40-hour week and anything over is considered time and a half. ",
                new String[]{"$793.50 ", " $739.50 ",
                        " $759.00 ", " $690.00 "}));

        questions.add(new QuestionModel("A businessman decided to lose 15 2/3 pounds before applying for health insurance." +
                " How much did he weigh after his weight loss if he originally weighed 208 1/8 pounds? ",
        ...
        questions.add(new QuestionModel("Phyllis paid $22.3293 in sales tax on an item costing $318.99. What sales tax percentage did Phyllis pay?",
                new String[]{"7.0%", " .07%",
                        " .1428% ", " 14.28%"}));
        questions.add(new QuestionModel("You are on a 5-hour trip, and your speed for the first two hours only " +
                "averaged 58 mph because of slow traffic. How fast must you drive for the last 3 hours to average 65 mph for the entire trip(round up if needed)?",
